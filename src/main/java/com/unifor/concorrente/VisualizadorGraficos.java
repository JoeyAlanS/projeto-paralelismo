...
public class VisualizadorGraficos extends JFrame {

    public VisualizadorGraficos(String csvFilePath) {
        setTitle("CCT - Ciência da Computação UNIFOR - Gráfico de Desempenho");
        setSize(900, 600);
